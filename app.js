...
const aboutContent = "About our blog website, we are more than just storytellers; we are a collective of passionate individuals driven by the belief that knowledge shared is knowledge multiplied. Our journey began with a shared vision of creating a space where ideas flourish and perspectives intertwine. Here, you'll get to know the faces behind the words, the storytellers who strive to bring you engaging and thought-provoking content. Our diverse team is united by a common thread: a love for exploration, learning, and the art of expression.Let's embark on a continuous journey of discovery, curiosity, and meaningful connections.";
const contactContent = "We value the thoughts, questions, and feedback from our readers, and we're thrilled that you're reaching out. Whether you have a suggestion for a topic you'd love to see covered, want to collaborate with our talented team, or simply wish to share your thoughts on a recent post, your input is invaluable to us. Feel free to drop us a message using the form below, and we'll make sure to get back to you promptly. Your engagement is what makes this community thrive, and we look forward to hearing from you. Let's keep the conversation going!";
const app = express();
